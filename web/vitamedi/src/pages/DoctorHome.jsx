    ...
    <DoctorDashboardLayout>
      <div className="relative min-h-screen pb-16">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {actions.map((item, index) => (
              ...
              >
                <div
                  className={`bg-gradient-to-br ${item.bg} rounded-2xl shadow-lg p-6 h-full transition-all transform group-hover:scale-[1.03] group-hover:shadow-xl`}
                >
        ...
        <button
          ...
          className="fixed bottom-4 left-4 bg-red-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-red-600 flex items-center gap-2"
        >
          <FaSignOutAlt /> Logout
        </button>
      </div>
